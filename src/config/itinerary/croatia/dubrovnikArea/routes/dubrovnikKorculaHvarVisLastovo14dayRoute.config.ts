...
const dubrovnikKorculaHvarVisLastovo14dayRoute: ItineraryRoute = {
  metaTitle: '14-Day Dubrovnik–Korčula–Hvar–Vis Yacht Route | Boat4You',
  metaDesc:
  ...
  routeDays: [
    {
      ...
      day: 1,
      mapPin: {
        desktop: { left: 86.3, top: 82 },
        mobile: { left: 86.3, top: 82 },
      },
      shortDescription:
        '8 nm northwest from ACI Marina Dubrovnik (Komolac) into Šipanska Luka — the largest of the Elaphiti chain and the natural soft kickoff before pushing west towards Mljet.',
      description:
      ...
      gallery: [{ src: '/images/itinerary/croatia/destinations/sipan.webp', alt: 'Sipan' }],
    },
    {
      ...
      mapPin: {
        desktop: { left: 67.9, top: 76.1 },
        mobile: { left: 67.9, top: 76.1 },
      },
      day: 2,
      shortDescription:
    ...
    },
    {
      ...
      mapPin: {
        desktop: { left: 58.4, top: 64.7 },
        mobile: { left: 58.4, top: 64.7 },
      },
      day: 3,
      shortDescription:
        '18 nm northwest along the Pelješac Channel into Korčula Town — walled medieval port, the precursor to Venetian radial street grids, with a Moreška sword-dance performance Mon and Thu evenings in season.',
      description:
    ...
    },
    {
      ...
      routeTo: 'Šćedro',
      mapPin: {
        desktop: { left: 45.1, top: 64.3 },
        mobile: { left: 45.1, top: 64.3 },
      },
      day: 4,
      shortDescription:
        '12 nm north into the channel between Korčula and Hvar to Šćedro, a small uninhabited island with a few sheltered bays and free konoba buoys. No town, no traffic, the quietest stop on the route.',
      description:
        'Twelve miles north into the channel between Korčula and Hvar takes you to Šćedro, a small uninhabited island sitting halfway between the two larger islands and almost completely off the regular charter circuit. There is no permanent population, no town, no infrastructure beyond two seasonal beach restaurants on the north coast that lay free mooring buoys for guests who eat ashore. The two main bays are Lovišće on the north (the larger, with more buoys and the better-known of the two) and Mostir on the south (smaller, quieter, with the ruins of a 14th-century Dominican monastery on the shore). Lovišće is the natural overnight: pick up a buoy, dinghy in, choose a konoba — Konoba Frankun and Konoba Mostir both run grilled-fish menus and the local Plavac Mali. The afternoon move is to walk the path inland to the monastery ruins on the south coast (40 minutes one way) or just snorkel from the boat. The water visibility runs to 25 metres on a calm summer day — the best on the route by a clear margin.',
      thingsToDo: [
      ...
      mooringTip:
        'Free konoba buoys at Lovišće on the north coast — dinner ashore secures the buoy, confirm on arrival. Anchoring on bottom possible (8–12 m, sand and weed) if buoys are full. Lovišće is sheltered from S, SW and SE; if N gradient forecast above 15 kn, push around to Mostir Bay on the south coast for the night.',
      gallery: [{ src: '/images/itinerary/croatia/destinations/scedro.webp', alt: 'Šćedro' }],
    },
    {
      id: 'scedro-vis-town',
      routeFrom: 'Šćedro',
      routeTo: 'Vis Town',
      mapPin: {
        desktop: { left: 28.4, top: 58.4 },
        mobile: { left: 28.4, top: 58.4 },
      },
      day: 5,
      shortDescription:
        '20 nm west to Vis Town on the north coast of Vis — set in the wide, fully-sheltered St. George Bay with the largest natural harbour on the island and ACI-style mooring on the seafront promenade.',
      description:
        "Twenty miles west takes you to Vis Town, the larger of Vis island's two settlements, set on the north coast in the wide St. George Bay. Unlike Komiža on the western side (a working fishing port with limited mooring), Vis Town has a long curved seafront promenade with stern-to mooring across most of its length — modest harbour fee, water and power on the central berths. The bay is fully sheltered from S, SW, W and NW; only N gradient (rare in summer) is exposed. Vis Town was the seat of the Roman colony of Issa from 397 BC and the earliest Greek settlement on the entire eastern Adriatic; the surviving Roman thermae (baths) and the Hellenistic walls along the harbour promenade are the headline archaeological stops. The Austro-Hungarian Fort George above the town (19th-century, walking-accessible) gives the panoramic view east over the harbour. Konoba dinner runs on the indigenous Vugava white, peka-cooked octopus, and the local Plavac Mali red — Vis is one of the densest wine-producing islands in Croatia despite its small size.",
      thingsToDo: [
    ...
    },
    {
      ...
      routeFrom: 'Komiža',
      routeTo: 'Biševo – Stari Grad',
      mapPin: {
        desktop: { left: 43.6, top: 49.4 },
        mobile: { left: 43.6, top: 49.4 },
      },
      day: 7,
      shortDescription:
    ...
    },
    {
      ...
      mapPin: {
        desktop: { left: 35.2, top: 50.2 },
        mobile: { left: 35.2, top: 50.2 },
      },
      day: 8,
      shortDescription:
    ...
    },
    {
      ...
      mapPin: {
        desktop: { left: 50.9, top: 77.1 },
        mobile: { left: 50.9, top: 77.1 },
      },
      day: 10,
      shortDescription:
    ...
    },
    {
      ...
      mapPin: {
        desktop: { left: 65, top: 65 },
        mobile: { left: 65, top: 65 },
      },
      day: 11,
      shortDescription:
        '20 nm northeast to Pomena, the small village at the western tip of Mljet and the eastern landing of Mljet National Park. Park buoys in the bay, walking access to Malo Jezero saltwater lake.',
      description:
      ...
      gallery: [{ src: '/images/itinerary/croatia/destinations/pomena.webp', alt: 'Mljet' }],
    },
    {
    ...
    },
    {
      ...
      mooringTip:
        'Stern-to on Lopud village quay with own anchor — modest fee, water and power on the central berths. Bay is well-sheltered from S, SE and SW; exposed to N gradient. If N forecast above 18 kn, push 4 nm into the more sheltered Šipanska Luka on Šipan or directly back into ACI Marina Dubrovnik.',
    ...
    },
    {
      ...
      day: 14,
      mapPin: {
        desktop: { left: 89.4, top: 85.6 },
        mobile: { left: 89.4, top: 85.6 },
      },
      shortDescription:
        '8 nm southeast back into ACI Marina Dubrovnik in Komolac for the Saturday handover by 09:00. Final stop at Koločep islet for a swim before pushing into the Rijeka Dubrovačka river estuary.',
      description:
        'The final leg is eight miles southeast from Lopud back into ACI Marina Dubrovnik in Komolac. Saturday handover protocol applies: the boat must be back at base by 09:00 with fuel topped, holding tanks emptied, decks rinsed and inventory checked, with the skipper available for the off-going inspection between 08:00 and 09:00. The course passes Koločep, the smallest and closest of the three inhabited Elaphiti Islands, and the small bays on its eastern coast are the standard final-swim stop on the way south — drop the hook in 6–8 metres on sand, swim once, then push into the Rijeka Dubrovačka river estuary and up to the marina pontoon. ACI Marina Dubrovnik sits eight kilometres inland from the Old City; once fuel is pumped and inspection clear, Bus 1A or a taxi takes you to the Pile Gate of the Old City in 15 minutes. The walls walk and a long lunch in the back lanes off Prijeko close the week. The 14-day Dubrovnik round trip is one of the most extensive routes available on the entire Croatian coast.',
      thingsToDo: [
  ...
  map: {
    desktop: {
      image: {
        ...
        alt: 'Dubrovnik – Korčula – Hvar – Vis – Lastovo Route Image',
      },
      width: 2422,
      height: 1550,
    },
...
export default computeItineraryNumberOfDays(dubrovnikKorculaHvarVisLastovo14dayRoute);
