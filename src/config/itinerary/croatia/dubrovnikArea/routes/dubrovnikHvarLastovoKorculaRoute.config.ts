...
const dubrovnikHvarLastovoKorculaRoute: ItineraryRoute = {
  metaTitle: '7-Day Dubrovnik–Mljet–Korčula–Hvar Yacht Route | Boat4You',
  metaDesc:
    '7-day yacht route from Dubrovnik via Mljet (Saplunara), Lastovo, Korčula, the Pakleni Islands & the Pelješac peninsula — sailor brief with NM and mooring notes.',
  id: 'dubrovnik-hvar-lastovo-korcula-route',
  startingPoint: 'Dubrovnik',
  otherPoints: ['Hvar', 'Lastovo', 'Korčula'],
  cardImage: {
    src: '/images/itinerary/croatia/split-dubrovnik-itinerary/routes/dubrovnik-hvar-card-image.webp',
    alt: 'Card image',
  },
  gallery: [
    {
  ...
  routeDays: [
    {
      id: 'dubrovnik-saplunara-mljet',
      routeFrom: 'Dubrovnik',
      routeTo: 'Saplunara (Mljet)',
      day: 1,
      mapPin: {
        desktop: { left: 76.8, top: 76.3 },
        mobile: { left: 70.5, top: 61.4 },
      },
      shortDescription:
        '20 nm northwest from ACI Marina Dubrovnik to Saplunara on Mljet’s southeast tip — one of the few sandy beaches on the Croatian coast and the natural first overnight outside the National Park boundary.',
      description:
    ...
    },
    {
      ...
      gallery: [{ src: '/images/itinerary/croatia/destinations/skrivena-luka.webp', alt: 'Skrivena Luka' }],
    },
    {
      ...
      day: 3,
      mapPin: {
        desktop: { left: 38.8, top: 51 },
        mobile: { left: 35.1, top: 48.3 },
      },
      shortDescription:
        '14 nm north to Vela Luka at the western end of Korčula — deep west-facing harbour with full town services, fuel pump, and excellent shelter. The natural Day 3 stop on a southern-arc round trip.',
      description:
        "Fourteen miles north takes you to Vela Luka, the deep west-facing harbour at the western end of Korčula. The bay is fully sheltered from N, NE and E; only S gradient above 18 kn pushes any swell into the inner harbour, and even then the inner pontoon stays comfortable. Mooring is straightforward: stern-to with own anchor on the long town quay, modest fee, water and power on the central section, fuel pump at the western end. Vela Luka village wraps the inner half of the harbour, with three good konobas on the waterfront promenade — the headline dish is žrnovski makaruni, a hand-rolled pasta tradition that two of the village kitchens still maintain by hand. The afternoon move is a 30-minute walk inland to Vela Spila ('Big Cave'), a prehistoric site with 20,000 years of continuous occupation that has produced some of the most important Mesolithic finds in the eastern Adriatic; the cave is open to visitors with a guide booked at the village tourist office.",
      thingsToDo: [
        ...
        'Take the dinghy out to the small islets at the bay entrance',
      ],
      mooringTip:
    ...
    },
    {
      ...
      day: 4,
      mapPin: {
        desktop: { left: 46.4, top: 65.3 },
        mobile: { left: 40.1, top: 55.3 },
      },
      shortDescription:
    ...
    },
    {
      ...
      day: 5,
      mapPin: {
        desktop: { left: 49.6, top: 80.4 },
        mobile: { left: 44.9, top: 66.4 },
      },
      shortDescription:
        '22 nm southeast back across the Hvar Channel into Korčula Town — walled medieval port on the eastern tip of Korčula island, with a Moreška sword-dance performance Mon and Thu evenings in season.',
      description:
        'Twenty-two miles southeast back across the Hvar Channel takes you to Korčula Town, the walled medieval port on the eastern tip of Korčula island. The skyline is unmistakable from offshore: a peninsula of red roofs, a single bell tower, the limestone curtain wall sliding down to the sea on three sides. ACI Marina Korčula sits on the eastern side of the peninsula and offers full services with lazy lines; alternatively the town quay on the western side accepts a few stern-to boats with own anchor for a harbour fee — closer to the gates but exposed to W Maestral and rolly when the channel funnel kicks in around 14:00. The Old Town is genuinely small but the layout is famously the precursor to the radial grids the Venetians later used elsewhere. Headline stops: the Cathedral of St. Mark (climb the bell tower for the channel view), the (debated) Marco Polo House, the Land Gate. The Moreška sword-dance performance — a 16th-century theatrical sword combat between Christian and Moorish armies — runs Monday and Thursday evenings at 21:00 in season at the open-air theatre.',
      thingsToDo: [
    ...
    },
    {
      ...
      routeFrom: 'Korčula',
      routeTo: 'Kobaš (Pelješac Peninsula)',
      day: 6,
      mapPin: {
        desktop: { left: 76.7, top: 80.7 },
        mobile: { left: 71.2, top: 68.2 },
      },
      shortDescription:
        '15 nm east into Kobaš Bay on the south coast of Pelješac peninsula — a pine-walled cove with a single waterside konoba, free guest buoys, and the closest approach to the Pelješac wine country.',
      description:
        "Fifteen miles east takes you to Kobaš Bay on the south coast of Pelješac peninsula — Croatia's longest peninsula and the heartland of the indigenous Plavac Mali red, the parent grape of Zinfandel. Kobaš itself is a small pine-walled cove with a single waterside konoba (Konoba Kobaš), which lays free mooring buoys for guests who eat ashore — pick up a buoy, dinner reservation locks it. The headline draw is the Pelješac wine country: the steep south-facing vineyards on the cliffs above Dingač and Postup villages produce the densest, most concentrated Plavac Mali wines in Croatia, with the Dingač appellation in particular requiring 100% old-vine south-slope fruit. A 30-minute taxi or village shuttle from Kobaš gets you to the cellars at Bartulović, Grgić (the Croatian arm of Mike Grgich) or Saints Hills for tastings; book one or two ahead. Back at the boat for dinner: the konoba's headline dishes are local oysters from Mali Ston (the next bay east, the most famous oyster region in Croatia) and beef pasticada slow-cooked overnight.",
      thingsToDo: [
      ...
      gallery: [{ src: '/images/itinerary/croatia/destinations/peljesac.webp', alt: 'Pelješec' }],
    },
    {
      id: 'kobas-dubrovnik',
      routeFrom: 'Kobaš',
      ...
      day: 7,
      mapPin: {
        desktop: { left: 89.9, top: 86.1 },
        mobile: { left: 91, top: 70.7 },
      },
      shortDescription:
        '25 nm southeast back into ACI Marina Dubrovnik in Komolac for the Saturday handover by 09:00. Final swim at one of the Elaphiti islands en route before pushing into the Rijeka Dubrovačka river estuary.',
      description:
        'The final leg is twenty-five miles southeast from Kobaš back into ACI Marina Dubrovnik in Komolac. Saturday handover protocol applies: the boat must be back at base by 09:00 with fuel topped, holding tanks emptied, decks rinsed and inventory checked, with the skipper available for the off-going inspection between 08:00 and 09:00. The course passes the Elaphiti chain on the way south — a final swim stop in Šipanska Luka or off the western beach of Lopud is the standard close to the week before pushing into the Rijeka Dubrovačka river estuary and up to the marina pontoon. ACI Marina Dubrovnik sits eight kilometres inland from the Old City; once fuel is pumped and inspection clear, Bus 1A or a taxi takes you to the Pile Gate of the Old City in 15 minutes. The walls walk and a long lunch in the back lanes off Prijeko close the week. The route just covered is one of the most sheltered 7-day options out of Dubrovnik — the southern-arc routing avoids the longer crossings to Vis and the time pressure of trying to push to Hvar Town for nightlife.',
      thingsToDo: [
        'Stop for a final swim at Lopud or Šipanska Luka',
  ...
  map: {
    desktop: {
      image: {
        ...
        alt: 'Dubrovnik – Hvar – Lastovo – Korčula Route Image',
      },
      width: 2422,
      height: 1550,
    },
...
export default computeItineraryNumberOfDays(dubrovnikHvarLastovoKorculaRoute);
