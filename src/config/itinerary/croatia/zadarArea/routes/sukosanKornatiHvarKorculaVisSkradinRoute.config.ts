...
const sukosanKornatiHvarKorculaVisSkradin14DaysRoute: ItineraryRoute = {
  ...
  routeDays: [
    ...
    },
    {
      ...
      day: 2,
      mapPin: {
        desktop: { left: 20, top: 20 },
        mobile: { left: 20.4, top: 34.4 },
      },
      description:
        'Go north to the wild essence of Dugi Otok. Pantera Bay runs your boat between gravel coastlines and pine-covered cliffs. Kayak via secret sea tunnels, then climb to Veli Rat Lighthouse, whose white spire cuts through gold evening. Feast under constellations on grilled squid, the murmur of the water spinning old stories.',
      shortDescription:
    ...
    },
    {
      ...
      day: 3,
      mapPin: {
        desktop: { left: 35.1, top: 48.4 },
        mobile: { left: 36, top: 50.4 },
      },
      description:
    ...
    },
    {
      ...
      day: 4,
      mapPin: {
        desktop: { left: 54.7, top: 59.3 },
        mobile: { left: 59.9, top: 60.4 },
      },
      description:
    ...
    },
    {
      ...
      day: 5,
      mapPin: {
        desktop: { left: 62.9, top: 63.2 },
        mobile: { left: 69.2, top: 61.1 },
      },
      description:
    ...
    },
    {
      ...
      day: 6,
      mapPin: {
        desktop: { left: 70.3, top: 72.8 },
        mobile: { left: 77.9, top: 72.8 },
      },
      description:
    ...
    },
    {
      ...
      day: 7,
      mapPin: {
        desktop: { left: 94.7, top: 89.7 },
        mobile: { left: 94.9, top: 81.7 },
      },
      description:
    ...
    },
    {
      ...
      day: 9,
      mapPin: {
        desktop: { left: 62.8, top: 87.9 },
        mobile: { left: 66.5, top: 77 },
      },
      description:
    ...
    },
    {
      ...
      day: 10,
      mapPin: {
        desktop: { left: 52, top: 55.7 },
        mobile: { left: 54.4, top: 57.1 },
      },
      description:
    ...
    },
    {
      ...
      day: 12,
      mapPin: {
        desktop: { left: 44.2, top: 45.9 },
        mobile: { left: 42, top: 48.5 },
      },
      description:
      ...
      shortDescription:
        'Easy 8 nm back down the river and along the coast to Tijat — a tiny uninhabited island in the Šibenik archipelago, surrounded by pine-clad islets.',
      thingsToDo: [
    ...
    },
    {
      ...
      day: 13,
      mapPin: {
        desktop: { left: 37.6, top: 42.9 },
        mobile: { left: 43.2, top: 43.3 },
      },
      description:
      ...
      shortDescription:
        'Easy 8 nm to Murter — the gateway island for Kornati charters. Slanica Beach is the headline sandy bay. Marina Hramina or Marina Betina (both within 1 nm of Murter Town) — pre-book in summer.',
      thingsToDo: [
...
export default computeItineraryNumberOfDays(sukosanKornatiHvarKorculaVisSkradin14DaysRoute);
