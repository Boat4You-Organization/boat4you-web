...
const trogirDubrovnikTrogir14DaysRoute: ItineraryRoute = {
  metaTitle: '14-Day Trogir to Dubrovnik Round-Trip Yacht Route | Boat4You',
  metaDesc:
    '14-day yacht route from ACI Trogir south to Dubrovnik via Hvar, Vis, Lastovo & Mljet — return via Korčula & Brač. Sailor brief with NM and mooring notes.',
  id: 'trogir-dubrovnik-trogir-14day-route',
  startingPoint: 'Trogir',
  otherPoints: ['Dubrovnik'],
  cardImage: {
    src: '/images/itinerary/croatia/split-dubrovnik-itinerary/routes/trogir-dubrovnik-card-image.webp',
    alt: 'Card image',
  },
  gallery: [
    {
  ...
  routeDays: [
    {
      ...
      day: 1,
      mapPin: {
        desktop: { left: 31.9, top: 35.3 },
        mobile: { left: 25.5, top: 36.7 },
      },
      shortDescription:
    ...
    },
    {
      ...
      day: 2,
      mapPin: {
        desktop: { left: 38.3, top: 42.6 },
        mobile: { left: 31.3, top: 39.6 },
      },
      shortDescription:
        '12 nm east across the Brač Channel into Milna, the most sheltered harbour on Brač’s western coast. A short, easy passage that lands you in the lamb-peka village by lunch.',
      description:
        "Twelve miles east across the Brač Channel takes you to Milna — the deep, narrow inlet on Brač's western coast that has been a working harbour since the Venetian era. The entrance is unmistakable: the 17th-century parish church on the inner quay marks the line, the bay narrows in past the church and offers stern-to mooring with own anchor for the entire inner half. Outer half is the anchorage — drop the hook in 6–10 metres of sand and take a stern line to the rocks if the afternoon Maestral picks up. Brač is famous for two things, the white limestone (the same stone used for Diocletian's Palace and quarried for centuries at Pučišća on the north coast) and the lamb under the peka, the village's three-hour Sunday lunch tradition. Order the peka by 14:00 — three hours of slow cooking under hot embers is non-negotiable — then fill the gap with a swim and a walk to the small church on the headland north of the bay.",
      thingsToDo: [
      ...
      gallery: [
        {
          src: '/images/itinerary/croatia/destinations/milna.webp',
          alt: 'Milna',
        },
      ],
    },
    {
      ...
      day: 3,
      mapPin: {
        desktop: { left: 36.5, top: 50.8 },
        mobile: { left: 28.6, top: 49.1 },
      },
      shortDescription:
        '15 nm southeast across the Hvar Channel into Palmižana on Sv. Klement — the only inhabited islet in the Pakleni cluster and the only one with a marina, with three south-side coves as the comfortable anchorage backups.',
      description:
        "From Milna the leg bends southeast for 15 miles across the Hvar Channel into the Pakleni Islands — the long string of pine-covered islets that screen the southern approach to Hvar Town. Palmižana sits on the eastern side of Sv. Klement (the largest islet in the cluster) and is the only one of the cluster with a marina: Palmižana ACI Marina, with stern-to lazy-line slots and limited summer capacity. The main bay holds in 5–10 metres on a sand-and-weed bottom but turns rolly when the Maestral funnel kicks in around 14:00, so the more comfortable overnight options are the south-side coves: Vinogradišće and Tarsce, both holding well in W gradient with line ashore the standard configuration. The afternoon ritual on Palmižana is the Meneghello family's 1906 botanical garden, dinner at one of the four konobas spread along the bay, and snorkelling over the submerged Roman amphorae off the western shore. Hvar Town is a short water-taxi hop east if the crew wants the nightlife — but the Palmižana side is the calmer overnight every time.",
      thingsToDo: [
    ...
    },
    {
      ...
      day: 4,
      mapPin: {
        desktop: { left: 30.3, top: 56.9 },
        mobile: { left: 21.7, top: 52.2 },
      },
      shortDescription:
        '20 nm southwest from the Pakleni cluster to Komiža on Vis — working fishing port on the western side of the island, the most authentic of the central Adriatic harbours and the best sunset on the route.',
      description:
        "Twenty miles southwest from the Pakleni cluster takes you to Komiža, the working fishing port on the western side of Vis. Vis is the most westerly inhabited Croatian island and the 1989 lifting of its closed-zone military status is still visible in the relative absence of resort development — the small towns on the island still feel like the Adriatic of three decades ago. Komiža itself is small enough to walk in fifteen minutes: the working fishing fleet on the eastern side of the harbour, the Fishermen's Museum in the old Venetian tower (open afternoons), and the konoba scene built around grilled bogueroni and the indigenous Vugava white. The harbour is split between the inner basin (stern-to with own anchor on a sand-and-weed bottom, mostly good holding) and the outer wall (open to SW swell, unsuitable overnight). Vis is also where the British SOE and Tito's Partisans coordinated WWII operations — Tito's Cave on Mount Hum is open as a site, and the hike up gets you the best 360° view in central Dalmatia.",
      thingsToDo: [
    ...
    },
    {
      ...
      day: 5,
      mapPin: {
        desktop: { left: 46.2, top: 66.9 },
        mobile: { left: 46, top: 56.9 },
      },
      shortDescription:
        'Two-cave morning then 18 nm east to Vela Luka at the western end of Korčula. Day driven by the Blue Cave morning sun-angle window — Biševo first, then Ravnik, then push east.',
      description:
        "The day is dictated by the sun angle inside the Blue Cave on Biševo: the underwater opening lights the cavern interior an unreal ultramarine only between roughly 09:00 and 11:00. Tie alongside the small concession quay outside the entrance (no overnight, lunchtime fee paid at the kiosk) and queue for one of the official tenders that ferry visitors inside; private dinghies are not allowed in. Forty minutes in and out, then back on board for the short hop east to Ravnik islet and its Green Cave (Zelena špilja), which lights through a roof opening rather than underwater — open to private dinghies, easier and less crowded than Biševo. By early afternoon the route pushes 18 miles east to Korčula's Vela Luka, the deep west-facing harbour at the end of the island. Excellent shelter from N to E; full town services. Konoba dinner runs on žrnovski makaruni, the hand-rolled local pasta that is still made by hand in two of the village kitchens.",
      thingsToDo: [
    ...
    },
    {
      ...
      day: 6,
      mapPin: {
        desktop: { left: 50.2, top: 76.9 },
        mobile: { left: 46.3, top: 64.1 },
      },
      shortDescription:
        '14 nm south to Lastovo, the most isolated inhabited Adriatic island and a designated Nature Park. Zaklopatica is the natural overnight — five konobas with free buoys, the lowest light pollution in Croatia.',
      description:
    ...
    },
    {
      ...
      day: 9,
      mapPin: {
        desktop: { left: 75.7, top: 81.1 },
        mobile: { left: 64.7, top: 64.5 },
      },
      shortDescription:
      ...
      mooringTip:
        'Free konoba buoys at Okuklje, dinner reservation locks the buoy — confirm on arrival. Anchoring on the bottom is possible but holding is patchy in seagrass. Bay is fully sheltered N, E and S; only NW gradient above 18 kn pushes any noticeable swell into the entrance.',
      gallery: [
        {
    ...
    },
    {
      ...
      day: 11,
      mapPin: {
        desktop: { left: 45.6, top: 50.1 },
        mobile: { left: 40.7, top: 46.4 },
      },
      shortDescription:
        '23 nm northwest across the Hvar Channel into Jelsa on the central north coast of Hvar — the quieter alternative to Hvar Town, with the lavender belt running inland and the UNESCO Stari Grad Plain a short bike away.',
      description:
        "Twenty-three miles northwest from Korčula across the Hvar Channel into Jelsa — the third-largest town on Hvar island, set on the central north coast, and roughly half the size and a quarter of the noise of Hvar Town on the south side. The bay is wide and well-sheltered from southern gradients; the town quay accepts stern-to with own anchor for a harbour fee (good holding in mud and sand), and a small marina on the eastern side handles boats that need lazy lines and shore power overnight. Jelsa is the working heart of Hvar's interior agriculture: the lavender belt that fills the road inland to Vrboska and Stari Grad still produces commercial yields each July, and the konobas in the back lanes lean on the local Bogdanjuša white wine and the Faros (Greek-name) cheese. Two strong afternoon options: bike the three miles along the coast road to Vrboska, sometimes called 'the little Venice of Hvar' for its canal-bridged centre, or walk inland through the Stari Grad Plain — UNESCO-listed, one of the oldest continuously cultivated landscapes in Europe.",
      thingsToDo: [
    ...
    },
    {
      ...
      day: 12,
      mapPin: {
        desktop: { left: 42.6, top: 44.5 },
        mobile: { left: 36.5, top: 42.5 },
      },
      shortDescription:
        '10 nm north across the Brač Channel to Lučice — chain of small adjoining bays just east of Pučišća. No town, no quay, two seasonal beach restaurants with free buoys, and the cleanest swimming on the route.',
      description:
    ...
    },
    {
      ...
      mooringTip:
        'Anchor in 4–6 m on excellent sand holding (the standard choice — bay is shallow and forgiving). Free restaurant buoys also available with dinner ashore. Bay is sheltered from N, NE, E, S and SE; exposed only to W and NW. If W gradient forecast above 18 kn, push 4 nm east directly into ACI Marina Trogir.',
      gallery: [{ src: '/images/itinerary/croatia/destinations/krknjasi.webp', alt: 'krknjasi' }],
    },
    {
      id: 'krknjasi-bay-trogir',
      routeFrom: 'Krknjaši Bay',
      routeTo: 'Trogir',
      day: 14,
      mapPin: {
        desktop: { left: 31.7, top: 27.7 },
        mobile: { left: 21.8, top: 33.6 },
      },
      shortDescription:
        '4 nm east into ACI Marina Trogir for the Saturday handover by 09:00. Unrushed morning, a final swim, fuel pumped, decks washed, then the airport transfer ten minutes north.',
      description:
        "The last leg is the shortest on the entire 14-day round trip: four miles east from Krknjaši into ACI Marina Trogir. Saturday handover protocol applies — the boat must be back at base by 09:00 with fuel topped, holding tanks emptied, decks rinsed and inventory checked, with the skipper available for the off-going inspection between 08:00 and 09:00. ACI Marina Trogir sits on the western side of Čiovo island, immediately east of the UNESCO old town of Trogir. Once fuel is pumped and inspection clear, the marina is a 5-minute walk over the small bridge into Trogir's old town — the Cathedral of St. Lawrence with the 13th-century Radovan portal (one of the most important pieces of medieval Croatian sculpture) is the headline stop, the Riva runs west along the marina side. Split airport is 10 minutes north by car. A long lunch on the Riva or a slow walk through the old town closes the week — this 14-day round trip is one of the most extensive routes available out of any Adriatic charter base, and the moment the boat is signed off, the satisfaction is fully earned.",
      thingsToDo: [
        'Top up fuel and pump out before the 09:00 inspection',
        "Walk Trogir UNESCO old town and the Cathedral's Radovan portal",
        'Visit the Kamerlengo fortress on the western tip of Čiovo',
        'Take a final swim at the small beach on the south side of Čiovo',
      ...
      gallery: [
        {
          src: '/images/itinerary/croatia/destinations/trogir.webp',
          alt: 'Trogir',
        },
      ],
    },
  ...
  map: {
    desktop: {
      image: {
        ...
        alt: 'Trogir – Dubrovnik – Trogir Route Image',
      },
      width: 2422,
      height: 1550,
    },
...
export default computeItineraryNumberOfDays(trogirDubrovnikTrogir14DaysRoute);
