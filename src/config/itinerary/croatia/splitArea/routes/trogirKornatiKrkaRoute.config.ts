...
const trogirKornatiKrkaRoute: ItineraryRoute = {
  metaTitle: '7-Day Trogir to Kornati and Krka Yacht Route | Boat4You',
  metaDesc:
  ...
  id: 'trogir-kornati-krka-route',
  startingPoint: 'Trogir',
  otherPoints: ['Kornati', 'Krka'],
  cardImage: {
    src: '/images/itinerary/croatia/split-dubrovnik-itinerary/routes/trogir-kornati-card-image.webp',
    alt: 'Card image',
  },
  gallery: [
    {
  ...
  routeDays: [
    ...
    },
    {
      ...
      shortDescription:
        '20 nm back downriver and southeast along the open coast to Rogoznica — peninsula town with the inland Dragon’s Eye salt lake and Marina Frapa, one of the largest marinas in central Dalmatia.',
      description:
    ...
    },
    {
      ...
      mooringTip:
        'Return into your booked Boat4You base — ACI Marina Trogir, Marina Kaštela or ACI Marina Split, whichever is on your charter contract. All three accept stern-to or alongside per the base manager’s direction. Saturday handover window 08:00–09:00; arrive by 17:00 Friday if your contract specifies night-before return.',
  ...
  map: {
    desktop: {
      image: {
        ...
        alt: 'Trogir – Kornati – Krka Route Image',
      },
      width: 2422,
      height: 1550,
    },
...
export default computeItineraryNumberOfDays(trogirKornatiKrkaRoute);
