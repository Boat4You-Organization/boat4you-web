...
const frenchCanalsItinerary: Itinerary = {
  ...
  image: { src: '/images/itinerary/france/french-canals-photos/canal-du-midi-barge.webp', alt: 'French Canals' },
  title: 'French Canals sailing itineraries',
  backgroundImage: {
    src: '/images/itinerary/france/french-canals-photos/canal-du-midi-barge.webp',
    alt: 'French Canals',
  },
